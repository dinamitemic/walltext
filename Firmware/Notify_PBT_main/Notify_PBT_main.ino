...
const uint8_t BT_RECV_PIN = 10;   // Arduino receive -> Bluetooth TxD pin
const uint8_t BT_SEND_PIN = 11;   // Arduino send -> Bluetooth RxD pin
const char BT_NAME[] = "TextWallReceiver";
...
// initialise the BT device for different hardware
{
  ...
  // Process all the AT commands for the selected BT modu\\le
